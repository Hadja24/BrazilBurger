...
public class BurgerView {
    ...
    public void createBurger() {
        try {
            ...
            // Saisie de l'URL de l'image (obligatoire)
            String imageURL = null;
            while (imageURL == null || imageURL.trim().isEmpty()) {
                System.out.print("Image URL (obligatoire): ");
                imageURL = scanner.nextLine().trim();
                if (imageURL.isEmpty()) {
                    System.out.println("❌ L'URL de l'image est obligatoire.");
                }
            }
            
            // Création du burger
            Burger burger = new Burger(null, name, price, imageURL, false);
